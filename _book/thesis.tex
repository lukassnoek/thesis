...
\section{Procedure}\label{shared-states-methods-procedure}}
...
\section{Image acquisition}\label{shared-states-methods-image-acquisition}}
...
\section{Preprocessing and single-trial modeling}\label{shared-states-methods-preprocessing}}

\hypertarget{shared-states-methods-mvpa}{%
\section{Multi-voxel pattern analysis}\label{shared-states-methods-mvpa}}

\hypertarget{shared-states-methods-mvpa-pipeline}{%
\subsection{MVPA pipeline}\label{shared-states-methods-mvpa-pipeline}}

\hypertarget{shared-states-methods-mvpa-cv-and-bagging}{%
\subsection{Cross-validation scheme and bagging procedure}\label{shared-states-methods-mvpa-cv-and-bagging}}

\hypertarget{shared-states-methods-mvpa-statistical-evaluation}{%
\subsection{Statistical evaluation}\label{shared-states-methods-mvpa-statistical-evaluation}}

\hypertarget{shared-states-methods-mvpa-spatial-representation}{%
\subsection{Spatial representation}\label{shared-states-methods-mvpa-spatial-representation}}

\hypertarget{shared-states-methods-additional-analyses}{%
\section{Additional analyses}\label{shared-states-methods-additional-analyses}}

\hypertarget{shared-states-methods-univariate-analysis}{%
\section{Univariate analysis}\label{shared-states-methods-univariate-analysis}}

\hypertarget{shared-states-methods-code-availability}{%
\section{Code availability}\label{shared-states-methods-code-availability}}

\hypertarget{shared-states-results}{%
\chapter{Results}\label{shared-states-results}}
